...
from diffusionflow.operators.operator_ids import STABLE_DIFFUSION_35_LARGE_VAE_ID
...
class StableDiffusion35LargeVAE(Operator):
    def setup_io(self):
    ...
    @property
    def id(self) -> str:
        return STABLE_DIFFUSION_35_LARGE_VAE_ID
...
if __name__ == "__main__":
    test_model_memory_allocation(model=StableDiffusion35LargeVAE(), model_path=None)

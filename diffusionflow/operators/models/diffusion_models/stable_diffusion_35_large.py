...
from diffusionflow.operators.operator_ids import STABLE_DIFFUSION_35_LARGE_ID
...
class StableDiffusion35Large(BaseDiffusionModel):
    def setup_io(self):
        super().setup_io()
    ...
    @property
    def id(self) -> str:
        return STABLE_DIFFUSION_35_LARGE_ID
...
if __name__ == "__main__":
    test_model_memory_allocation(model=StableDiffusion35Large(), model_path=None)

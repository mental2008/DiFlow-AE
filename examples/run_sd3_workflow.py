...
if __name__ == "__main__":
    ...
    elif service_id == "sd3_txt2img_lora_controlnet_canny_cfg_workflow":
        # Load and encode the control image
        control_image = load_image("imgs/canny.jpg")
        control_image = control_image.convert("RGB")
        buffered = io.BytesIO()

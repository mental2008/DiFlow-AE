# python examples/register_sd3_txt2img_controlnet_canny_cfg_workflow.py
import argparse
...
def create_workflow(
    model_path: str, controlnet_model_path: str, lora_model_path: str
) -> Workflow:
    workflow = Workflow(name="sd3_txt2img_lora_controlnet_canny_cfg_workflow")

# python examples/register_sd35_large_txt2img_controlnet_canny_cfg_workflow.py
import argparse
...
def create_workflow(model_path: str, controlnet_model_path: str) -> Workflow:
    workflow = Workflow(name="sd35_large_txt2img_controlnet_canny_cfg_workflow")
    ...
    controlnet = StableDiffusion35LargeControlNetCanny(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="/project/infattllm/lyangbk/huggingface/diffusers-internal-dev--sd35-controlnet-canny-8b",
    )

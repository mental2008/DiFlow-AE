# python examples/register_flux_schnell_txt2img_controlnet_canny_cfg_workflow.py
import argparse
import base64
import io
...
def create_workflow(model_path: str, controlnet_model_path: str) -> Workflow:
    workflow = Workflow(name="flux_schnell_txt2img_controlnet_canny_cfg_workflow")
    ...
    flux1_schnell = Flux1Schnell(Config(model_path=model_path))
    vae = Flux1VAE(Config(model_path=model_path))
    controlnet = Flux1DevControlNetCanny(Config(model_path=controlnet_model_path))
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="/project/infattllm/lyangbk/huggingface/Xlabs-AI--flux-controlnet-canny-diffusers",
    )

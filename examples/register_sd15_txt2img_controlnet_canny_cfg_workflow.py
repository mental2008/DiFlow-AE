# python examples/register_sd15_txt2img_controlnet_canny_cfg_workflow.py
import argparse
import base64
import io
...
def create_workflow(model_path: str, controlnet_model_path: str) -> Workflow:
    workflow = Workflow(name="sd15_txt2img_controlnet_canny_cfg_workflow")
    ...
    controlnet = StableDiffusion15ControlNetCanny(
    ...
    negative_prompt_embeds = clip_sd15(prompt=negative_prompt)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="/project/infattllm/lyangbk/huggingface/lllyasviel--sd-controlnet-canny",
    )

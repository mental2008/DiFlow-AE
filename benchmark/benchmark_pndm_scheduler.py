...
from diffusionflow.operators.schedulers.pndm_scheduler import (
    PNDMScheduler,
)
...
def benchmark_pndm_scheduler_init_func(
    model_instance: Any,
...
def benchmark_pndm_scheduler_step_func(
    model_instance: Any,
    model_components: Dict[str, Any],
    batch_size: int,
    height: int,
    ...
    **kwargs,
    ...
    """Benchmark function for PNDMScheduler model"""
    ...
    timestep = torch.tensor(901, dtype=torch.int64, device=device)
...
def benchmark_pndm_scheduler_step_classifier_free_guidance_func(
    model_instance: Any,
    model_components: Dict[str, Any],
    batch_size: int,
    height: int,
...
if __name__ == "__main__":
    ...
    results = run_model_benchmark(
        ...
        benchmark_func=[
            benchmark_pndm_scheduler_init_func,
            benchmark_pndm_scheduler_step_func,
            benchmark_pndm_scheduler_step_classifier_free_guidance_func,
        ],

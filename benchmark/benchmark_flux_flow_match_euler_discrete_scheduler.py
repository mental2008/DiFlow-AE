...
def benchmark_flux_flow_match_euler_discrete_scheduler_init_func(
    model_instance: Any,
    ...
    **kwargs,
    ...
    """Benchmark function for FluxFlowMatchEulerDiscreteScheduler model"""
...
def benchmark_flux_flow_match_euler_discrete_scheduler_step_func(
    model_instance: Any,
    model_components: Dict[str, Any],
    batch_size: int,
    height: int,
...
def benchmark_flux_flow_match_euler_discrete_scheduler_step_classifier_free_guidance_func(
    model_instance: Any,
    model_components: Dict[str, Any],
    batch_size: int,
    height: int,
...
if __name__ == "__main__":
    ...
    model_name = FluxFlowMatchEulerDiscreteScheduler().id
    ...
    results = run_model_benchmark(
        ...
        benchmark_func=[
            benchmark_flux_flow_match_euler_discrete_scheduler_init_func,
            benchmark_flux_flow_match_euler_discrete_scheduler_step_func,
            benchmark_flux_flow_match_euler_discrete_scheduler_step_classifier_free_guidance_func,
        ],

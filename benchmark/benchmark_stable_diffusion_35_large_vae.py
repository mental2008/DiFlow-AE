...
def benchmark_stable_diffusion_35_large_vae_prepare_image_func(
    model_instance: Any,
    ...
    **kwargs
    ...
    """Benchmark function for StableDiffusion35Large VAE model"""
    image = torch.randn(
...
def benchmark_stable_diffusion_35_large_vae_decode_latents_func(
    model_instance: Any,
    model_components: Dict[str, Any],
    batch_size: int,
    height: int,
...
if __name__ == "__main__":
    ...
    model_name = StableDiffusion35LargeVAE().id
    ...
    results = run_model_benchmark(
        ...
        benchmark_func=[
            benchmark_stable_diffusion_35_large_vae_prepare_image_func,
            benchmark_stable_diffusion_35_large_vae_decode_latents_func,
        ],

...
def benchmark_stable_diffusion_3_controlnet_func(
    model_instance: Any,
    ...
    **kwargs,
    ...
    """Benchmark function for StableDiffusion3ControlNet model"""
...
if __name__ == "__main__":
    controlnets = [
        (
            StableDiffusion3ControlNetCanny().id,
            "/project/infattllm/lyangbk/huggingface/sd3-controlnet-canny",
        ),
        (
            StableDiffusion3ControlNetPose().id,
            "/project/infattllm/lyangbk/huggingface/sd3-controlnet-pose",
        ),
    ]
    ...
    for controlnet_name, controlnet_model_path in controlnets:
        ...
        results = run_model_benchmark(
            ...
            benchmark_func=[benchmark_stable_diffusion_3_controlnet_func],
            config=[config],
        )

...
case $setting in
    s1)
        baseline_config="submodules/baselines/baseline_configs/shepherd_S1.yml"
        ;;
    s2)
        baseline_config="submodules/baselines/baseline_configs/shepherd_S2.yml"
        ;;
    s3)
        baseline_config="submodules/baselines/baseline_configs/shepherd_S3.yml"
        ;;
    *)
